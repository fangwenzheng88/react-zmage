...
var DEF_PROP_DESKTOP = default_objectSpread(default_objectSpread({}, default_defProp), defPreset.desktop);

var DEF_PROP_MOBILE = default_objectSpread(default_objectSpread({}, default_defProp), defPreset.mobile);
...
var Portal_Portals = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Portals, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/external_react_dom_default.a.createPortal(children, this.container);
    }
  }]);
...
function IconArrowLeft_createSuper(Derived) { var hasNativeReflectConstruct = IconArrowLeft_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = IconArrowLeft_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = IconArrowLeft_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return IconArrowLeft_possibleConstructorReturn(this, result); }; }
...
function IconArrowRight_createSuper(Derived) { var hasNativeReflectConstruct = IconArrowRight_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = IconArrowRight_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = IconArrowRight_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return IconArrowRight_possibleConstructorReturn(this, result); }; }
...
function IconClose_createSuper(Derived) { var hasNativeReflectConstruct = IconClose_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = IconClose_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = IconClose_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return IconClose_possibleConstructorReturn(this, result); }; }
...
function IconDownload_createSuper(Derived) { var hasNativeReflectConstruct = IconDownload_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = IconDownload_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = IconDownload_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return IconDownload_possibleConstructorReturn(this, result); }; }
...
function IconLoading_createSuper(Derived) { var hasNativeReflectConstruct = IconLoading_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = IconLoading_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = IconLoading_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return IconLoading_possibleConstructorReturn(this, result); }; }
...
function IconRefresh_createSuper(Derived) { var hasNativeReflectConstruct = IconRefresh_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = IconRefresh_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = IconRefresh_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return IconRefresh_possibleConstructorReturn(this, result); }; }
...
function IconRotateRight_createSuper(Derived) { var hasNativeReflectConstruct = IconRotateRight_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = IconRotateRight_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = IconRotateRight_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return IconRotateRight_possibleConstructorReturn(this, result); }; }
...
function IconZoom_createSuper(Derived) { var hasNativeReflectConstruct = IconZoom_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = IconZoom_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = IconZoom_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return IconZoom_possibleConstructorReturn(this, result); }; }
...
var Context = /*#__PURE__*/Object(external_react_["createContext"])();
...
var withVendorPrefix = external_lodash_memoize_default()(function (style) {
  ...
  return Object.keys(style).reduce(function (styleAcc, styleCur) {
    var stylesWithPrefix = vendorPrefixList.reduce(function (prefixAcc, prefixCur) {
      return utils_objectSpread(utils_objectSpread({}, prefixAcc), {}, utils_defineProperty({}, "".concat(prefixCur).concat(uppercaseFirstLetter(styleCur)), style[styleCur]));
    }, {});
    return utils_objectSpread(utils_objectSpread({}, styleAcc), stylesWithPrefix);
  }, style);
});
/**
 * 是否数字
...
function Control_createSuper(Derived) { var hasNativeReflectConstruct = Control_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = Control_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = Control_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Control_possibleConstructorReturn(this, result); }; }
...
var Image_Image_Image = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Image(props, context) {
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "handleSetTimestamp", function (page) {
      ...
      _this.setState({
        timestamp: Image_objectSpread(Image_objectSpread({}, timestamp), {}, Image_defineProperty({}, set[page].src, new Date().getTime()))
      });
    });
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "setCurrentStyle", function (nextStyle) {
      ...
      _this.setState({
        currentStyle: nextStyle._behavior === 'merge' ? Image_objectSpread(Image_objectSpread({}, currentStyle), nextStyle) : nextStyle,
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "getStyle", function (step, distance, isSideImage) {
      ...
      return Image_objectSpread(Image_objectSpread({}, withVendorPrefix({
        transform: transform
      })), {}, {
    ...
    _this.imageRef = /*#__PURE__*/external_react_default.a.createRef(); // 初始页面高度
...
function Browser_createSuper(Derived) { var hasNativeReflectConstruct = Browser_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = Browser_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = Browser_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Browser_possibleConstructorReturn(this, result); }; }
...
var Browser_Browser_Browser = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Browser(props) {
    ...
    Browser_defineProperty(Browser_assertThisInitialized(_this), "getPropsWithEnv", function () {
      ...
      return Browser_objectSpread(Browser_objectSpread({}, _this.props), {}, {
        // Preset flags
        presetIsMobile: preset === 'mobile',
        presetIsDesktop: preset !== 'mobile',
        // Control
        controller: Browser_objectSpread(Browser_objectSpread({}, defProp.controller), controller),
        hotKey: Browser_objectSpread(Browser_objectSpread({}, defProp.hotKey), hotKey),
        animate: Browser_objectSpread(Browser_objectSpread({}, defProp.animate), animate)
      });
    });
  ...
  Browser_createClass(Browser, [{
    ...
    value: function render() {
      ...
      var contextValue = Browser_objectSpread(Browser_objectSpread({
        // Internal
        coverRef: coverRef,
        coverPos: coverPos,
...
Browser_Browser_Browser.defaultProps = {
  ...
  browsing: false,
  // Internal
  coverRef: /*#__PURE__*/external_react_default.a.createRef(),
...
function Zmage_callee_createSuper(Derived) { var hasNativeReflectConstruct = Zmage_callee_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = Zmage_callee_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = Zmage_callee_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Zmage_callee_possibleConstructorReturn(this, result); }; }
...
var RENDER = {
  REF: /*#__PURE__*/external_react_default.a.createRef(),
  CONTAINER: null,
  PORTAL: null
}; // 调用函数
...
var Zmage_wrapper_ReactZmageWrapper = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function ReactZmageWrapper(props) {
        ...
        _this.contentRef.current.querySelectorAll('img').forEach(function (item) {
          if (!item.getAttribute('zmage') && item.getAttribute('src')) {
            ...
            item.addEventListener('click', function () {
              return Zmage_callee(Zmage_wrapper_objectSpread(Zmage_wrapper_objectSpread({}, restProps), {}, {
                coverRef: {
                  current: item
                },
    ...
    _this.contentRef = /*#__PURE__*/external_react_default.a.createRef();
    return _this;
  }
...
function Zmage_createSuper(Derived) { var hasNativeReflectConstruct = Zmage_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = Zmage_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = Zmage_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Zmage_possibleConstructorReturn(this, result); }; }
...
var Zmage_ReactZmage = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function ReactZmage(props) {
    ...
    _this.coverRef = /*#__PURE__*/external_react_default.a.createRef();
...
var forwardedReactZmage = /*#__PURE__*/external_react_default.a.forwardRef(function (props, ref) {
